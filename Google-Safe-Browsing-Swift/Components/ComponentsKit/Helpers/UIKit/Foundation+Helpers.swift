...
//  Google-Safe-Browsing-Swift
//
//  Created by HAU NGUYEN on 16/6/25.
...
extension Foundation.Bundle {
    ...
    static let module: Bundle = {
        let bundleName = "ComponentsKit_ComponentsKit"
        ...
        fatalError("unable to find bundle named ComponentsKit_ComponentsKit")
    }()
}
